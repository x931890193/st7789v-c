...
uint8_t *time_hour_min_nums[10] = {image_data_0, image_data_1, image_data_2, image_data_3,
                                         image_data_4, image_data_5, image_data_6, image_data_7,
                                         image_data_8, image_data_9}; // 0-9

uint8_t *time_sec_mu_nums[10] = {image_data_l0c, image_data_l1c, image_data_l2c, image_data_l3c,
